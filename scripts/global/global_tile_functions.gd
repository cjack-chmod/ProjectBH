...
func find_tile_coordinates(_global_pos: Vector2, tile_map: TileMap) -> Vector2:
...
func find_centre_of_tile(_tile_coords: Vector2, tile_map: TileMap) -> Vector2:
...
func find_adjacent_tile(_tile_coords: Vector2, _direction: HEXDIR, tile_map: TileMap) -> Vector2:
